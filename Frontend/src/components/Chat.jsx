...
import { Button, TextField, Box, Typography, Paper, Card, CardContent, CardHeader } from '@mui/material'
        ...
        {messages.map((msg, index) => (
          <Box
            ...
            sx={{
              ...
              backgroundColor: msg.sender === currentUserId ? 'tertiary.main' : 'grey.200',
