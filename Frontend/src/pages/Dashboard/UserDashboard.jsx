...
<Box sx={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 3 }}>
    ...
    <Box sx={{ position: 'absolute', right: 0, top: 0 }}>
        ...
        >
          ...
          />
          <SearchIcon
            sx={{ width: 50, height: 50, color: "grey.700", ml: 3 }}
          />
        </Box>
          ...
          <Grid item xs={12} sm={6} sx={{ p: 3, mt: 3 }}>
            ...
            >
              <Typography variant="body2" component="body1" color="grey.100">
                Bid and negotiate your crops through here. Give a questionnaire
                and a tailored list of buyers is ready!
              </Typography>
            </Box>
            <Link to="/GetInfo">
              <Button
        ...
        <Box
          sx={{ color: "#fcb603", width: "100px", height: "100px", mx: "auto" }}
        >
          <EmojiEventsIcon
            sx={{ color: "#fcb603", width: "100px", height: "100px" }}
          />
        </Box>
        <Typography
          variant="h2"
        ...
        >
          {["Dealer 1", "Dealer 2", "Dealer 3"].map((dealer) => (
            <Card sx={{ backgroundColor: "grey.100", mx: 3, p: 3, width: 250 }}>
              <CardMedia component="img" image={avatar} alt="person" />
              <CardContent>
        ...
        <Box sx={{ display: "flex", mt: 4, gap: 2 }}>
          <Box sx={{ width: "30%", pr: 2 }}>
            <MilitaryTechIcon
              sx={{ color: "#fcb603", width: "100px", height: "100px", mx: 3 }}
            />
            <Typography
              variant="h3"
              component="h3"
              sx={{ textAlign: "left", fontWeight: "bold", mx: 5 }}
            >
              Our <br />
              Top <br /> Ten Users
            </Typography>
          ...
          <Box sx={{ width: "70%" }}>
            <List>
              {["Dealer A", "Dealer B", "Dealer C", "Dealer D", "Dealer E"].map(
                (person, index) => (
                  <>
                    <ListItem>
                      <Card
